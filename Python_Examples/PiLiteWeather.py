...
class WeatherPoll(JSONPoll):
    def __init__(self, location, message_format=""):
        ...
        # You must replace appid=xxxxxxxxxxxxxxxx with your own vaild key (free plan is okay) http://openweathermap.org/appid
        base_url = "http://api.openweathermap.org/data/2.5/weather?q=%s&appid=xxxxxxxxxxxxxxxx"
